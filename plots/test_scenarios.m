...
% See the examples in section 6 of Wave Scattering Periodic Media
% in references for more information

% Test 1: Vacuum over a Dielectric
n_u = 1.0;
n_w = 1.1;

% Test 2: Vacuum over metals
% n_u = 1.0; 
% n_w = 0.05 + 2.275*1i; % Silver
% n_w = 1.48 + 1.883*1i; % Gold
...
% Reduce the regularity of f by decreasing the surface smoothness
% Sawtooth/Lipschitz
%P = 40;
